...
public class CouponController {
    ...
    // add :  chan  2018/4/4
    @ResponseBody
    @PostMapping("/findMoreByValid")
    public String findMoreByValid(@RequestParam(value = "page")Integer page,@RequestParam(value = "num")Integer num,@RequestParam(value = "valid")Integer valid) {
        return JsonObject.toJson(couponService.selectMoreByValid((page-1)*num,num,valid));
    }
