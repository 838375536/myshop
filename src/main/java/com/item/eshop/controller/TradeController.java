...
//    }
    ...
    @ResponseBody
    @PostMapping("/findByRefund")
    public String findByRefund(@RequestParam(value = "page") Integer page, @RequestParam(value = "num") Integer num) {
        String set = "5,6";
        List<Trade> trade = tradeService.selectBySets(set,(page-1)*num,num);
        return JsonObject.toJson(trade);
    }
    ...
    @ResponseBody
    @PostMapping("/findByRefunds")
    public String findByRefunds(@RequestParam(value = "page") Integer page, @RequestParam(value = "num") Integer num) {
        String set = "5,6,7,8";
        List<Trade> trade = tradeService.selectBySets(set,(page-1)*num,num);
        return JsonObject.toJson(trade);
    }
