...
//    }
    ...
    public String findMore() {
        return JsonObject.toJson(recommendService.selectMore(0,15));
    }
    ...
    public String findByType() {
        return JsonObject.toJson(recommendService.selectByType(1,0,15));
    }
...
//    }
    ...
    @ResponseBody
    @PostMapping("/update")
    public int update(@RequestParam(value = "id")int id,@RequestParam(value = "image",required = false)MultipartFile image) {
    ...
    public int updateLikes(@RequestParam(value = "id")int id,@RequestParam(value = "num")int num) {
        Recommend recommend = recommendService.selectByPrimaryKey(id);
        recommend.setId(id);
        recommend.setGoodId(recommend.getGoodId()+num);
        return recommendService.updateByPrimaryKeySelective(recommend);
    }
}
