...
public class GoodServiceImpl implements GoodService {
    ...
    @Override
    public List<Good> selectByNullCategory(Integer page, Integer num) {
        return goodMapper.selectByNullCategory(page,num);
    }

    @Override
    public Integer updateCategoryToNull(Integer id) {
        return goodMapper.updateCategoryToNull(id);
    }

    @Override
    public Integer updateCategory(Integer category, Integer id) {
        return goodMapper.updateCategory(category,id);
    }
