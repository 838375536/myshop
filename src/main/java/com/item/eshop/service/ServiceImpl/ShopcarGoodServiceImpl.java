...
public class ShopcarGoodServiceImpl implements ShopcarGoodService {
    ...
    @Override
    public ShopcarGood selectByGoodAndOther(Integer good_id, String other, Integer user_id) {
        return shopcarGoodMapper.selectByGoodAndOther(good_id,other,user_id);
    }
